...
import { findEmptyCellKeys, readPngFile } from './png-alpha-utils.js'
...
function findEmptyCells(filePath, dimensions, frameWidth, frameHeight, frameColumns, frameRows) {
  ...
  try {
    ...
    if (png.width !== dimensions.width || png.height !== dimensions.height) return undefined
    return findEmptyCellKeys(png, frameWidth, frameHeight, frameColumns, frameRows)
  } catch {
    return undefined
  }
}
